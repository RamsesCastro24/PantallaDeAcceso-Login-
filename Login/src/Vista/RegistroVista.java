...
public class RegistroVista extends JFrame {
    ...
    public RegistroVista() {
        ...
        RegNombreE.setForeground(new Color(0,0,0));
        ...
        RegUsE.setForeground(new Color(0,0,0));
        ...
        RegUs.setForeground(new Color(0,0,0));
        ...
        RegPassE.setForeground(new Color(0,0,0));
        ...
        RegPass2E.setForeground(new Color(0,0,0));
